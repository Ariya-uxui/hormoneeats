...
function QuestionCard({ q, qIndex, total, selected, onSelect, tokens }) {
  return (
    <div style={{ flex:1, display:"flex", flexDirection:"column" }}>
      {/* Q counter */}
      <div style={{ fontSize:11, color:tokens.stone, marginBottom:6, letterSpacing:".06em" }}>
      ...
      <div style={{
        ...
        padding:"4px 12px", marginBottom:12, alignSelf:"flex-start",
      ...
      <div style={{
        ...
        fontSize:18, color:tokens.cocoa, lineHeight:1.45, marginBottom:16,
      }}>
        {q.question}
      </div>
    ...
    <div style={{
      ...
      {step === "quiz" && (
        <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden" }}>
          ...
          {/* Question */}
          <div className="scroll-body" style={{ flex:1, padding:"20px" }}>
            <QuestionCard
              q={currentQ}
              qIndex={qIndex}

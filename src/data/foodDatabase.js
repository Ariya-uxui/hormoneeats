...
export const CUISINES = [
  { id: "all",     label: "ทั้งหมด", labelEn: "All",   labelEn: "All",      emoji: "🌏" },
  { id: "thai",    label: "ไทย",       labelEn: "Thai",     emoji: "🇹🇭" },
  { id: "japanese",label: "ญี่ปุ่น",  labelEn: "Japanese", emoji: "🇯🇵" },
  { id: "korean",  label: "เกาหลี",    labelEn: "Korean",   emoji: "🇰🇷" },
  { id: "western", label: "ตะวันตก",  labelEn: "Western",  emoji: "🌍" },
]
 
export const CATEGORIES = [
  { id: "all",       label: "ทั้งหมด", labelEn: "All"      },
  { id: "rice",      label: "ข้าว/เส้น", labelEn: "Rice/Noodle"   },
  { id: "protein",   label: "โปรตีน", labelEn: "Protein"      },
  { id: "soup",      label: "ซุป/แกง", labelEn: "Soup/Curry"     },
  { id: "salad",     label: "สลัด/ผัก", labelEn: "Salad/Veg"    },
  { id: "snack",     label: "ของว่าง", labelEn: "Snack"     },
  { id: "fruit",     label: "ผลไม้", labelEn: "Fruit"       },
  { id: "coffee",    label: "☕ กาแฟ", labelEn: "☕ Coffee"     },
  { id: "tea",       label: "🍵 ชา", labelEn: "🍵 Tea"       },
  { id: "milk",      label: "🥛 นม/โยเกิร์ต", labelEn: "🥛 Milk/Yogurt"},
  { id: "smoothie",  label: "🥤 สมูทตี้", labelEn: "🥤 Smoothie"  },
  { id: "coldpress", label: "🌿 สกัดเย็น", labelEn: "🌿 Cold Press" },
  { id: "drink",     label: "เครื่องดื่มอื่น", labelEn: "Other Drinks"},
]
 
export const HORMONE_TAGS = {
  boost:   { label: "ช่วยฮอร์โมน",   labelEn: "Hormone Boost",     bg: "#EDE8F5", color: "#3C3489" },
  good:    { label: "ดีต่อฮอร์โมน",  labelEn: "Hormone Friendly",  bg: "#EAF0EA", color: "#4A6454" },
  neutral: { label: "ปกติ",          labelEn: "Regular",           bg: "#F0EDE8", color: "#9A9490" },
  avoid:   { label: "ควรเลี่ยง",     labelEn: "Limit",             bg: "#F5EEF1", color: "#8B4050" },
}
...
export const FOOD_DB = [
  ...
  { id:102, emoji:"🌾", name:"ข้าวกล้อง 1 ทัพพี",   nameEn:"Brown Rice",        cal:165, protein:4,  carb:36, fat:1,  fiber:2, cat:"rice",    cuisine:"thai",    hormoneTag:"good",    hormoneNote:"ไฟเบอร์ช่วย detox Estrogen", hormoneNoteEn:"Fiber helps detox Estrogen",   phase:["follicular","ovulation"] },
  ...
  // protein
  { id:111, emoji:"🍗", name:"ไก่ย่าง (อก)",          nameEn:"Grilled Chicken",   cal:200, protein:30, carb:2,  fat:8,  fiber:0, cat:"protein", cuisine:"thai",    hormoneTag:"good",    hormoneNote:"โปรตีนสูง ช่วยสร้างกล้ามเนื้อ", hormoneNoteEn:"High protein, builds muscle", phase:["ovulation","follicular"] },
  { id:112, emoji:"🐟", name:"ปลาทอด",                nameEn:"Fried Fish",        cal:250, protein:28, carb:8,  fat:12, fiber:0, cat:"protein", cuisine:"thai",    hormoneTag:"good",    hormoneNote:"Omega-3 สมดุลฮอร์โมน", hormoneNoteEn:"Omega-3 balances hormones",          phase:["ovulation","luteal"] },
  { id:113, emoji:"🦐", name:"กุ้งผัดพริก",            nameEn:"Stir-fry Shrimp",   cal:185, protein:22, carb:6,  fat:8,  fiber:1, cat:"protein", cuisine:"thai",    hormoneTag:"good",    hormoneNote:"โปรตีนต่ำแคล", hormoneNoteEn:"Low-cal protein",                 phase:["ovulation"] },
  { id:114, emoji:"🥚", name:"ไข่ต้ม 2 ฟอง",          nameEn:"Boiled Eggs",       cal:140, protein:12, carb:1,  fat:10, fiber:0, cat:"protein", cuisine:"thai",    hormoneTag:"good",    hormoneNote:"Choline บำรุงฮอร์โมน", hormoneNoteEn:"Choline supports hormones",          phase:["follicular","ovulation"] },
  ...
  // soup / curry
  { id:121, emoji:"🫕", name:"ต้มยำกุ้ง",              nameEn:"Tom Yum Goong",     cal:160, protein:20, carb:8,  fat:6,  fiber:2, cat:"soup",    cuisine:"thai",    hormoneTag:"boost",   hormoneNote:"ขิง+ตะไคร้ต้านอักเสบ ลด Cortisol", hormoneNoteEn:"Ginger+Lemongrass reduce inflammation, lower Cortisol", phase:["luteal","menstrual"] },
  ...
  { id:123, emoji:"🥘", name:"ต้มข่าไก่",              nameEn:"Tom Kha Gai",       cal:220, protein:18, carb:6,  fat:14, fiber:1, cat:"soup",    cuisine:"thai",    hormoneTag:"boost",   hormoneNote:"ข่าลดอักเสบ สมดุล Progesterone", hormoneNoteEn:"Galangal reduces inflammation, balances Progesterone", phase:["luteal"] },
  ...
  { id:313, emoji:"🥚", name:"ไข่ตุ๋นเกาหลี (Gyeran Jjim)",nameEn:"Steamed Egg",  cal:80,  protein:7,  carb:1,  fat:5,  fiber:0, cat:"protein", cuisine:"korean",  hormoneTag:"good",    hormoneNote:"Choline บำรุงฮอร์โมน", hormoneNoteEn:"Choline supports hormones",         phase:["follicular"] },
  ...
  { id:403, emoji:"🍞", name:"ขนมปังโฮลวีท 2 แผ่น",   nameEn:"Whole Wheat Bread", cal:160, protein:6,  carb:30, fat:2,  fiber:4, cat:"rice",    cuisine:"western", hormoneTag:"good",    hormoneNote:"ไฟเบอร์ช่วย detox Estrogen", hormoneNoteEn:"Fiber helps detox Estrogen",   phase:["follicular"] },
...
export const SNACK_DB = [
  ...
  /* ── 🍞 ขนมปัง / Bakery ── */
  { id:601, emoji:"🍞", name:"ขนมปังโฮลวีท 1 แผ่น",      nameEn:"Whole Wheat Bread",     cal:80,  protein:4,  carb:14, fat:1,  fiber:2, cat:"bakery",  cuisine:"western", hormoneTag:"good",    hormoneNote:"ไฟเบอร์สูง ช่วย detox Estrogen", hormoneNoteEn:"High fiber helps detox Estrogen",              phase:["follicular"] },
  { id:602, emoji:"🥖", name:"ขนมปังไรย์ 1 แผ่น",         nameEn:"Rye Bread",             cal:83,  protein:3,  carb:15, fat:1,  fiber:2, cat:"bakery",  cuisine:"western", hormoneTag:"good",    hormoneNote:"GI ต่ำ ไม่ spike Insulin", hormoneNoteEn:"Low GI, won't spike Insulin",                    phase:["follicular","luteal"] },
  ...
  { id:618, emoji:"🥒", name:"แตงกวา + กรีกโยเกิร์ต dip", nameEn:"Cucumber Yogurt Dip",   cal:80,  protein:6,  carb:8,  fat:2,  fiber:1, cat:"clean",   cuisine:"western", hormoneTag:"boost",   hormoneNote:"Probiotic + Hydration ลด Bloating", hormoneNoteEn:"Probiotic + Hydration reduces Bloating",          phase:["luteal"] },
  ...
  /* ── 🥑 ขนมคีโต / Low-carb ── */
  { id:621, emoji:"🥑", name:"คีโตบราวนี่ (อัลมอนด์แป้ง)", nameEn:"Keto Brownie",          cal:180, protein:5,  carb:6,  fat:16, fiber:3, cat:"keto",    cuisine:"western", hormoneTag:"boost",   hormoneNote:"ดาร์กช็อก + Almond flour Mg สูง ลด PMS", hormoneNoteEn:"Dark choc + Almond flour high in Mg, reduces PMS",    phase:["luteal","menstrual"] },
  ...
  { id:637, emoji:"🥥", name:"สังขยาฟักทอง",                nameEn:"Pumpkin Custard",       cal:140, protein:5,  carb:18, fat:6,  fiber:1, cat:"thaibake", cuisine:"thai",    hormoneTag:"good",    hormoneNote:"Beta-carotene + Ca บำรุงฮอร์โมน", hormoneNoteEn:"Beta-carotene + Ca support hormones",             phase:["follicular"] },
  ...
  { id:639, emoji:"🫘", name:"ถั่วกวน (ถั่วเขียว)",          nameEn:"Mung Bean Sweet",       cal:130, protein:4,  carb:26, fat:1,  fiber:3, cat:"thaibake", cuisine:"thai",    hormoneTag:"good",    hormoneNote:"Phytoestrogen จากถั่วเขียว สมดุล Estrogen", hormoneNoteEn:"Phytoestrogen from mung beans balances Estrogen",   phase:["follicular","luteal"] },
  { id:640, emoji:"🍌", name:"กล้วยบวชชี",                  nameEn:"Banana in Coconut Milk",cal:220, protein:2,  carb:42, fat:6,  fiber:2, cat:"thaibake", cuisine:"thai",    hormoneTag:"good",    hormoneNote:"แมกนีเซียมจากกล้วย ลด PMS", hormoneNoteEn:"Magnesium from banana reduces PMS",                  phase:["luteal"] },
]
...
CATEGORIES.push(
  { id: "bakery",   label: "🍞 ขนมปัง", labelEn: "🍞 Bakery"     },
  { id: "clean",    label: "🥗 ขนมคลีน", labelEn: "🥗 Clean Snack"    },
  { id: "keto",     label: "🥑 คีโต", labelEn: "🥑 Keto"        },
  { id: "thaibake", label: "🍮 ขนมไทย", labelEn: "🍮 Thai Dessert"     }
)